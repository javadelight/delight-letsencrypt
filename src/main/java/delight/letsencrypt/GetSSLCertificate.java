...
public class GetSSLCertificate {
    ...
    private static final File USER_KEY_FILE = new File("output/user.key");

    // File name of the Domain Key Pair
    private static final File DOMAIN_KEY_FILE = new File("output/domain.key");

    // File name of the CSR
    private static final File DOMAIN_CSR_FILE = new File("output/domain.csr");

    // File name of the signed certificate
    private static final File DOMAIN_CHAIN_FILE = new File("output/domain-chain.crt");
